...
export class NotePicker {
   ...
   */
  private getRandomPitch(p?: Note['pitch'], r = 0): number {
    if (r > 20) {
      Logger.warn(`recursion exceeded at getRandomPitch`)
      return this.scale.pickRandom()
    }
