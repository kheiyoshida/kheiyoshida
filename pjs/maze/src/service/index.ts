import { initializeEvent, recurringConstantEvent, recurringStandEvent } from '../domain/events/events'
...
export const initialize3d = () => {
  ...
  setInterval((frameCount) => FrameConsumer.consumeFrame(frameCount))
}
