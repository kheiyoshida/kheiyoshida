...
export const createDrumMachine = (kick = tightKick(), snare = tightSnare(), hh = closedHihat()) =>
...
export const tightDrums = () => createDrumMachine()
export const beatDrums = () => createDrumMachine(tightKick(), explicitSnare(), closedHihat())
