import { Channel, VideoChannel } from './channel'
...
export class ChannelManager {
  ...
  public set videoPlaybackSpeed(value: number) {
    ...
    if (this.currentChannel instanceof VideoChannel) {
  ...
  public getChannel(): Channel {
    ...
    if (this.currentChannel instanceof VideoChannel && fireByRate(this.videoSwitchRate)) {
  ...
  private getNextAvailableChannel(retry = 0): Channel {
