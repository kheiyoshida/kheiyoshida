...
const Menu2 = () => {
  ...
  return (
    <>
      <Link href={'/'} className={styles.menu__item__lv2}>~</Link>
      <div onClick={() => toggleItem('works')} className={styles.menu__item__lv2}>Works</div>
      {
      ...
      <div onClick={() => toggleItem('links')} className={styles.menu__item__lv2}>Links</div>
      {
      ...
      <div onClick={() => toggleItem('contact')} className={styles.menu__item__lv2}>Contact</div>
      {
