...
export const WorkEntities: WorkInfoNew[] = [
  {
    title: 'wasted',
    date: '240220',
    contents: [{ sketch: [sketchLink('wasted_revisited')] }],
  },
  {
    title: 'shinjuku',
    date: '240131',
  ...
  },
  {
    title: 'tp4',
    date: '231024',
    contents: [{ sketch: [sketchLink('tp4')] }],
  },
  {
    title: 'regrets',
    date: '230927',
  ...
  },
  {
    ...
    contents: [
      {
        images: ['bonsai1.png', 'bonsai2.png', 'bonsai3.png', 'bonsai4.png', 'bonsai5.png'],
      },
    ],
    options: {
      imageLayout: 'grid'
