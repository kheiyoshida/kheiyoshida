...
const workEntities: WorkInfo[] = [
  ...
  },
  {
    ...
    type: ['sketch', 'music'],
    musicLoc: [
      '<iframe style="margin-top: 8px;" width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1615352286&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>'
    ],
    title: 'wasted',
  },
  {
    ...
    title: 'maze',
    info: {
      link: `https://maze.kheiyoshida.com`,
    },
    description: `
  ...
  },
  {
    ...
    type: ['sketch'],
    title: 'gen',
    // description: 'source: https://github.com/kheiyoshida/sketch/tree/main/src/projects/gen',
  },
  {
    date: '221118',
    type: ['video', 'music'],
